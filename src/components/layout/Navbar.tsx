        ...
        <div className="global-p flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="md:hidden w-9 h-9 flex items-center justify-center bg-light-elevated dark:bg-dark-elevated border border-light-border dark:border-dark-border text-light-text-secondary dark:text-dark-text-secondary cursor-pointer"
