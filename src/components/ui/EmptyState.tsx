...
export function EmptyState({
  ...
  return (
    ...
    >
      <div className="w-16 h-16 bg-light-glass dark:bg-dark-glass border border-light-border dark:border-dark-border flex items-center justify-center text-2xl">
        ∅
      </div>
